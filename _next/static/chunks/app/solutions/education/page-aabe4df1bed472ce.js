try {
  ...
  s &&
    ...
    (e._sentryDebugIds[s] = "ec789576-11dd-490f-ab89-8d5803b19643"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-ec789576-11dd-490f-ab89-8d5803b19643"));
} catch (e) {}
{
  let e =
    "undefined" != typeof window
...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    32710: (e, s, t) => {
      Promise.resolve().then(t.bind(t, 48378)),
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("h2", {
                    ...
                    children: "Designed for academics",
                  }),
                  (0, i.jsx)("p", {
                    className: "text-text-md lg:text-text-lg text-gray-600",
                    children:
                      "Powering golden records of fraud-proof identity and credentials without compromising privacy.",
                  }),
                ],
              }),
              (0, i.jsxs)(n.FN, {
                      ...
                      children: [
                        (0, i.jsx)("div", {
                          ...
                          children: (0, i.jsx)(r.default, {
                            src: "/images/solutions/education/usecase-1.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            (0, i.jsx)("figcaption", {
                              ...
                              children: "Protect academic credentials",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Securely issue and verify tamper-proof student and educator identities and credentials to eliminate fake certificates and ensure trust. Private Verifiable Identities for students and educators that keep personal data safe and are interoperable across institutions and platforms.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, i.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, i.jsx)(r.default, {
                            src: "/images/solutions/education/usecase-2.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            (0, i.jsx)("figcaption", {
                              className:
                                "text-text-lg lg:text-text-xl font-bold text-gray-900 mb-4",
                              children: "Privacy-Preserving Analytics",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Leverage privacy-preserving analytics, powered by zero-knowledge cryptography, to gain insights into your educational community without the need to handle or reveal protected information.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, i.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, i.jsx)(r.default, {
                            src: "/images/solutions/education/usecase-3.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            (0, i.jsx)("figcaption", {
                              className:
                                "text-text-lg lg:text-text-xl font-bold text-gray-900 mb-4",
                              children: "Trusted User Lifecycle",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Instill trust and integrity throughout the learner lifecycle, from seamless onboarding to verification and engagement, with universal privacy-enhanced identities and credentials that work across platforms and institutions.",
                            }),
                          ],
                        }),
                      ],
  ...
  (e) => {
    var s = (s) => e((e.s = s));
    e.O(0, [7255, 507, 5602, 5148, 1860, 2086, 7358], () => s(32710)),
      (_N_E = e.O());
  },
]);
