try {
  ...
  s &&
    ...
    (e._sentryDebugIds[s] = "30c909f8-1760-474d-9420-1bdd01d10954"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-30c909f8-1760-474d-9420-1bdd01d10954"));
} catch (e) {}
{
  let e =
    "undefined" != typeof window
...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
              ...
              (0, r.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, r.jsx)("p", {
                    ...
                    children:
                      "T3 Verify is a regulatory-compliant KYC stack that provides a unified KYC standard for crypto finance and allows users to reuse KYC credentials across platforms and protocols.",
                  }),
                ],
              }),
              (0, r.jsxs)(n.FN, {
                      ...
                      children: [
                        (0, r.jsx)("div", {
                          ...
                          children: (0, r.jsx)(t.default, {
                            src: "/images/solutions/rwa/usecase-1.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, r.jsxs)("div", {
                          ...
                          children: [
                            (0, r.jsx)("figcaption", {
                              ...
                              children: "Real-time verification",
                            }),
                            (0, r.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Conduct fast and secure identity and liveness verification. Meet due diligence by running Watchlist reports on-chain AML at any point.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, r.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, r.jsx)(t.default, {
                            src: "/images/solutions/rwa/usecase-2.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, r.jsxs)("div", {
                          ...
                          children: [
                            (0, r.jsx)("figcaption", {
                              className:
                                "text-text-lg lg:text-text-xl font-bold text-gray-900 mb-4",
                              children: "Reusable Verifiable Credentials",
                            }),
                            (0, r.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Digital credentials that are interoperable across platforms, protocols, and jurisdictions for a seamless trading and redemption experience.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, r.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, r.jsx)(t.default, {
                            src: "/images/solutions/rwa/usecase-3.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
  ...
  (e) => {
    var s = (s) => e((e.s = s));
    e.O(0, [7255, 507, 5602, 5148, 1860, 2086, 7358], () => s(15500)),
      (_N_E = e.O());
  },
]);
