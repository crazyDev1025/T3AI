try {
  ...
  s &&
    ...
    (e._sentryDebugIds[s] = "5051511e-d096-4f5e-933f-41fd034caeeb"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-5051511e-d096-4f5e-933f-41fd034caeeb"));
} catch (e) {}
{
  let e =
    "undefined" != typeof window
...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    71619: (e, s, i) => {
      Promise.resolve().then(i.bind(i, 96931)),
              ...
              (0, t.jsxs)("div", {
                ...
                children: [
                  (0, t.jsx)("h2", {
                    ...
                    children: "Designed for governments",
                  }),
                  (0, t.jsx)("p", {
                    className: "text-text-md lg:text-text-lg text-gray-600",
                    children:
                      "Securely issue self-sovereign digital identities while prioritizing privacy and security.",
                  }),
                ],
              }),
              (0, t.jsxs)(r.FN, {
                      ...
                      children: [
                        (0, t.jsx)("div", {
                          ...
                          children: (0, t.jsx)(n.default, {
                            src: "/images/solutions/government/usecase-1.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, t.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, t.jsx)("p", {
                              ...
                              children:
                                "Strong encryption and authentication mechanisms at every step, reducing the risk of data breaches and unauthorized access.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, t.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, t.jsx)(n.default, {
                            src: "/images/solutions/government/usecase-2.png",
                            alt: "usecase",
                            height: 79,
                            width: 300,
                            className:
                              "w-auto h-[128px] lg:h-[79px] group-hover:scale-125 transition-all",
                            sizes: "100%",
                          }),
                        }),
                        (0, t.jsxs)("div", {
                          ...
                          children: [
                            (0, t.jsx)("figcaption", {
                              className:
                                "text-text-lg lg:text-text-xl font-bold text-gray-900 mb-4",
                              children: "AI & Fraud Protected",
                            }),
                            (0, t.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Safeguard identities with unbreakable & credible digital credentials fortified against AI-generated fraud, ensuring robust security and trust in digital interactions.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, t.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, t.jsx)(n.default, {
                            src: "/images/solutions/government/usecase-3.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, t.jsxs)("div", {
                          ...
                          children: [
                            (0, t.jsx)("figcaption", {
                              className:
                                "text-text-lg lg:text-text-xl font-bold text-gray-900 mb-4",
                              children: "Streamlined and Efficient Services",
                            }),
                            (0, t.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Improve care coordination with enhanced privacy, using universal tamper-proof identities and credentials to reduce administrative burdens.",
                            }),
                          ],
                        }),
                      ],
  ...
  (e) => {
    var s = (s) => e((e.s = s));
    e.O(0, [7255, 507, 5602, 5148, 1860, 2086, 7358], () => s(71619)),
      (_N_E = e.O());
  },
]);
