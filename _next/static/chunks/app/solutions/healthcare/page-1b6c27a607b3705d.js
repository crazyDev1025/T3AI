try {
  ...
  s &&
    ...
    (e._sentryDebugIds[s] = "17093851-056f-4885-9d54-015853867e51"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-17093851-056f-4885-9d54-015853867e51"));
} catch (e) {}
{
  let e =
    "undefined" != typeof window
...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    38483: (e, s, t) => {
      Promise.resolve().then(t.bind(t, 82491)),
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("h2", {
                    ...
                    children: "Designed for the healthcare industry",
                  }),
                  (0, i.jsx)("p", {
                    className: "text-text-md lg:text-text-lg text-gray-600",
                    children:
                      "Verify and issue tamper-proof health records, harness privacy-preserving analytics, and simplify onboarding with universal identities for seamless healthcare integration.",
                  }),
                ],
              }),
              (0, i.jsxs)(r.FN, {
                      ...
                      children: [
                        (0, i.jsx)("div", {
                          ...
                          children: (0, i.jsx)(n.default, {
                            src: "/images/solutions/healthcare/usecase-1.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                        ...
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            (0, i.jsx)("figcaption", {
                              ...
                              children: "Enhanced Security and Privacy",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Strong encryption and authentication mechanisms at every step across the onboarding process and patient lifecycle, reducing the risk of data breaches and unauthorized access.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, i.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, i.jsx)(n.default, {
                            src: "/images/solutions/healthcare/usecase-2.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                          ...
                          children: [
                            (0, i.jsx)("figcaption", {
                              className:
                                "text-text-lg lg:text-text-xl font-bold text-gray-900 mb-4",
                              children:
                                "Improved Patient Control and Consent Management",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Garner patient trust in healthcare with self-sovereign patient identity and records, giving patients greater control over their health information.",
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        (0, i.jsx)("div", {
                          className:
                            "h-[245px] lg:h-[300px] bg-primary-600 rounded-3xl bg-gradient-to-tr from-[#0B4A6F] to-[#0086C9] flex justify-center items-center",
                          children: (0, i.jsx)(n.default, {
                            src: "/images/solutions/healthcare/usecase-3.png",
                            alt: "usecase",
                            height: 128,
                            width: 300,
                            className:
                          ...
                          children: [
                            ...
                            (0, i.jsx)("p", {
                              className:
                                "text-text-sm marker:lg:text-text-md text-gray-600",
                              children:
                                "Improve care coordination with enhanced privacy, using universal identities and credentials to ensure accurate patient records across providers and systems.",
                            }),
                          ],
                        }),
                      ],
  ...
  (e) => {
    var s = (s) => e((e.s = s));
    e.O(0, [7255, 507, 5602, 5148, 1860, 2086, 7358], () => s(38483)),
      (_N_E = e.O());
  },
]);
